...
class TestTransformData:
    ...
    def test_transform_location(self, sample_address_dataframe):
        ...
        expected_columns = ['location_id', 'address_line_1', 'address_line_2', 'district', 'city',
    ...
    def test_transform_counterparty(self, sample_counterparty_dataframe, sample_address_dataframe):
        result = transform_counterparty(sample_counterparty_dataframe, sample_address_dataframe)
        ...
        assert result['counterparty_legal_address_line_1'].iloc[0] == '605 Haskell Trafficway'
        ...
        assert result['counterparty_legal_country'].iloc[0] == 'Heard Island and McDonald Islands'
