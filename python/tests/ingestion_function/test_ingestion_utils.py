...
class TestGetTimestamp:
    ...
    def test_successful_retrieval(self, ssm_client):
        ssm_client.put_parameter(
            Name="/ingestion/example_table/latest_extracted_timestamp",
...
class TestGetPacketId:
    ...
    def test_successful_retrieval(self, ssm_client):
        ssm_client.put_parameter(
            Name="/ingestion/example_table/latest_packet_id",
            Value="00000100",
            Type="String",
        )
...
class TestCollectTableData:
    ...
    @pytest.mark.skipif((os.getenv("ENVIRONMENT") != "DEV"), reason="Skipping for CI/CD")
